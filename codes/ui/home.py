...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Main_QF.setMinimumSize(QSize(0, 0))
        self.Main_QF.setStyleSheet(u"QFrame#Main_QF{\n"
"	background-color: qlineargradient(x0:0, y0:1, x1:1, y1:1,stop:0.4  rgb(100, 222, 210), stop:1 rgb(204, 224, 245));\n"
...
"border-radius: 15px;\n"
"background-color: qradialgradient(cx:0, cy:0, radius:1, fx:0.1, fy:0.1, stop:0 rgb(102, 139, 124),  stop:1 rgb(170, 194, 152));\n"
"border: 1px outset rgb(166, 194, 149)\n"
"}\n"
"")
        ...
        self.label_6.setStyleSheet(u"color: rgba(225, 255, 255,210);\n"
"padding-left:12px;\n"
...
"font: 17pt \"Microsoft YaHei UI\";")
        ...
        self.Class_QF.setMinimumSize(QSize(200, 80))
...
"font: 17pt \"Microsoft YaHei UI\";")
        ...
        self.Save_QF = QFrame(self.QF_Group)
        self.Save_QF.setObjectName(u"Save_QF")
        self.Save_QF.setMinimumSize(QSize(190, 85))
        self.Save_QF.setMaximumSize(QSize(190, 100))
        self.Save_QF.setStyleSheet(u"QFrame#Save_QF{\n"
"background-color: rgb(138, 142, 255);\n"
...
"}")
        ...
        self.ToggleBotton_5.setMinimumSize(QSize(0, 20))
        self.ToggleBotton_5.setMaximumSize(QSize(16777215, 20))
        font4 = QFont()
...
"        }")
        ...
        self.horizontalLayout_3.addWidget(self.Save_QF)
        ...
        self.pre_video.setStyleSheet(u"background-color: rgb(238, 242, 245);\n"
"border:2px solid rgb(255, 255, 255);\n"
"border-radius:15px")
        ...
        self.res_video.setStyleSheet(u"background-color: rgb(238, 242, 245);\n"
"border:2px solid rgb(255, 255, 255);\n"
"border-radius:15px")
...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Author.setText(QCoreApplication.translate("MainWindow", u"By Yezey", None))
        self.Title.setText(QCoreApplication.translate("MainWindow", u"seg&cls App ", None))
        ...
        self.explain_title.setText(QCoreApplication.translate("MainWindow", u"CologuardAI \u2013  A Graphical User Interface For Polyp segmentation and classification", None))
        self.min_sf.setText("")
        self.max_sf.setText("")
        self.close_button.setText("")
        self.char_label.setText(QCoreApplication.translate("MainWindow", u"基于内窥镜图像的息肉自动诊断系统", None))
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"\u76ee\u6807\u7c7b\u522b", None))
        self.Target_num.setText("")
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"\u5206\u7c7b\u7f6e\u4fe1\u5ea6", None))
        self.Class_num.setText("")
        self.ToggleBotton_5.setText(QCoreApplication.translate("MainWindow", u"\u4fdd\u5b58\u52fe\u9009", None))
        self.save_res_button.setText(QCoreApplication.translate("MainWindow", u"Save JPG", None))
